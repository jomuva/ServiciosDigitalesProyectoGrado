...
namespace Persistencia
{
    ...
    public partial class bdServiciosDigitalesProyEntities : DbContext
    {
        ...
        public virtual ObjectResult<ConsultarSolicitudesAPP_Result> ConsultarSolicitudesAPP()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ConsultarSolicitudesAPP_Result>("ConsultarSolicitudesAPP");
        }
    
        public virtual ObjectResult<ConsultarSolicitudesXCliente_Result> ConsultarSolicitudesXCliente(string usuario_login)
        {
            var usuario_loginParameter = usuario_login != null ?
                new ObjectParameter("usuario_login", usuario_login) :
                new ObjectParameter("usuario_login", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ConsultarSolicitudesXCliente_Result>("ConsultarSolicitudesXCliente", usuario_loginParameter);
        }
    
        public virtual ObjectResult<ConsultarSolicitudesXClienteAPP_Result> ConsultarSolicitudesXClienteAPP(string username)
        {
            var usernameParameter = username != null ?
                new ObjectParameter("username", username) :
                new ObjectParameter("username", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ConsultarSolicitudesXClienteAPP_Result>("ConsultarSolicitudesXClienteAPP", usernameParameter);
        }
